...
/**
 * This sample demonstrates how the MergeDocx utility can be used to merge docx
 * documents. It is one of two such samples, the other being
 * AltChunkProcessingExtension.
 *
 * The MergeDocx utility is a paid extension to docx4j. Purchases of this
 * extension support the docx4j project.
 *
 * @see <a href="http://dev.plutext.org/blog/2010/11/merging-word-documents/">
 * merging-word-documents blog post</a> for more info, or
 * @see <a href="http://www.plutext.com/">www.plutext.com</a> or email
 * sales@plutext.com if you want to buy it.
 *
 * To run the utility, you simply pass it a list of the docx you want to merge;
 * it returns a new pkg containing the merged documents.
 *
 * This example looks a little more complex, since it has to use reflection, so
 * that docx4j can still be built by users who don't have the MergeDocx code.
 *
 */
public class merge {

    //final static String BASE_DIR = System.getProperty("user.dir") + "/sample-docs/";
    final static String[] sourceDocxNames = {"E:/test1.docx", "E:/test1.docx"};
    static boolean save = true;
    static String outputfilepath =  "E:/MergeDocx_OUT.docx";
    ...
    public static void main(String[] args) throws Docx4JException {
        ...
        for (int i = 0; i < sourceDocxNames.length; i++) {
            String filename = sourceDocxNames[i];
