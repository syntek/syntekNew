...
public class DialogInsertNewFile extends javax.swing.JDialog {
    ...
    private void btnChooseFileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnChooseFileActionPerformed
        ...
        dialogChooseNewFile.setDocumentID(DocumentID);
    ...
    private void btnInsertFileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertFileActionPerformed
        ...
        try {
            String sql = "SELECT id FROM DocumentFile WHERE FileIndex = ? and DocumentID = ?";
            PreparedStatement ps = ConSQL.CON.prepareStatement(sql);
            ps.setInt(1, Integer.parseInt(txtIndex.getText()));
            ps.setString(2, DocumentID);
            ResultSet rs = ps.executeQuery();
            while (rs.next()) {
                JOptionPane.showMessageDialog(null, "Số thứ tự này đã tồn tại");
                check = false;
                break;
            }
